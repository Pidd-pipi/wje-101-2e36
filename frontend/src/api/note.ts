...
import type { NoteItem, NoteDetailData, TastingNote } from '@/constants/note'
...
export function getNote(id: number | string) { return request.get<never, NoteDetailData>(`/notes/${id}`) }
